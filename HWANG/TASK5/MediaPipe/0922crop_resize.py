...
def crop(input_dir, input_name, output_name):
    ...
    result_image = np.zeros((410, 380, 3), dtype=np.uint8)
    ...
    while cap.isOpened():
        ...
        result_image = image[start_y-60:start_y+h, start_x:start_x+w+30]
...
crop('./LJM/', 'cv_camera_sensor_stream_handler', './face_resize')