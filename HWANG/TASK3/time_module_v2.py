...
def main(input):
    ...
    while True:
        ...
        if cnt1 > 3 and cnt2 > 3:
            cap.set(cv2.CAP_PROP_POS_FRAMES, check_frame - 30 * fps)
            break
        check_frame += 10 * fps
    ...
    # 후반 시작 찾기
    # start_frame = first_half_end_frame + fps * 60 * 3
...
# start = time.time()
# input  = "tving_video_224/P470472958_EPI0006_01_t35.mp4"
# a, b, c, d = main(input)
# end = time.time()
# print(end - start)
