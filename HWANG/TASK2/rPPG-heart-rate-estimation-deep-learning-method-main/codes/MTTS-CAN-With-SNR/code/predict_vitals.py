...
def predict_vitals(args):
    ...
    img_cols = 36
    frame_depth = 10
    model_checkpoint = 'C:/Users/user/Desktop/Task2/rPPG-heart-rate-estimation-deep-learning-method-main/codes/MTTS-CAN-With-SNR/mtts_can.hdf5'
    # './mtts_can.hdf5'
    ...
    # GT 관련된 것들 제외(모두 주석 처리)
    # f = open("E:/UBFC/16.txt", "r")
    # f = open("C:/Users/user/Desktop/Task2/rPPG-heart-rate-estimation-deep-learning-method-main/codes/MTTS-CAN-With-SNR/test-txt/34.txt", "r")
    #
